...
#ifndef FL_RAPIDJSON_RAPIDJSON_H_
#define FL_RAPIDJSON_RAPIDJSON_H_
...
/*! \def RAPIDJSON_NAMESPACE_END
    ...
    \see RAPIDJSON_NAMESPACE
*/
// Force our own values here: don't just check #ifndef, because cocos2d-x's
// own bundled (older) rapidjson may have already defined these exact macro
// names earlier in the same translation unit (e.g. via cocos-ext.h). If we
// only checked #ifndef, we'd silently inherit its "rapidjson" namespace
// instead of getting our own "flrapidjson" one, and our classes would end
// up in the wrong (or a colliding) namespace.
#ifdef RAPIDJSON_NAMESPACE
#undef RAPIDJSON_NAMESPACE
#endif
#define RAPIDJSON_NAMESPACE flrapidjson

#ifdef RAPIDJSON_NAMESPACE_BEGIN
#undef RAPIDJSON_NAMESPACE_BEGIN
#endif
#define RAPIDJSON_NAMESPACE_BEGIN namespace RAPIDJSON_NAMESPACE {

#ifdef RAPIDJSON_NAMESPACE_END
...
#endif // FL_RAPIDJSON_RAPIDJSON_H_
